...
using TestM3.Authorization;
using TestM3.Helpers;
using TestM3.ViewModels;
...
namespace TestM3
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("TestM3"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "TestM3 API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, ILogger<Startup> logger, IDatabaseInitializer databaseInitializer)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "TestM3 API V1");
            });
